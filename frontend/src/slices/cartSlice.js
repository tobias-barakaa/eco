...
(localStorage.getItem('cart')) : { cartItems: [], shippingAddress: {}, paymenthMethod: 'PayPal' };
...
export const { addToCart,savePaymentMethod, removeFromCart, 
    saveShippingAddress, clearCartItems } = cartSlice.actions;
