...
# Path: backend/base/serializers.py

class Order(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    paymentMethod = models.CharField(max_length=200, null=False, blank=True)
...
class ShippingAddress(models.Model):
    ...
    postalCode = models.CharField(max_length=200, null=False, blank=True)
